...
export class DataService {
    getItems(): Array<Item> {
        return [{
            id: 1,
            name: "Σεισμοί",
            cover: "~/assets/images/seismoi_0.png",
            images: [
                "~/assets/images/food/burger/seismoi_0.jpg",
...
Μην πλησιάζετε τις ακτές για να παρακολουθήσετε ένα επερχόμενο τσουνάμι. Όταν το δείτε ίσως είναι αργά για να το αποφύγετε.`
        },
        {
            ...
            cover: "~/assets/images/katolisthiseis_1.png",
            images: [
...
Ελέγξτε για ζημιές τα κρίσιμα σημεία για την στατικότητα του σπιτιού σας.`
        },
        {
            ...
            cover: "~/assets/images/dasikes_pyrkagies_1.png",
            images: [
